...
- **Title/end cards** are config-driven: `titleText/titleSub/titleFont/titleSize/titleColor/titleSubColor/endTagline` (rail → Title & end cards), so SHARE LINK / COPY CONFIG carry them.
